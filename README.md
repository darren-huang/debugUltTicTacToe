...
1. Now on the toolbar at the top you should see a green "►" button. Click this to run all the tests. One test should fail!
...
#### Navigating Through Projects with Intellij

Dive into the code on IntelliJ. Use some of these IntelliJ features to help you navigate/explore the code:
